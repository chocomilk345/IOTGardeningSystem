...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","1","PASSWD"}, \
				{0,-1,"","JW_UBT","PASSWD"},  {0,-1,"","JW_ARD","PASSWD"}, \
				{0,-1,"","JW_AND","PASSWD"},  {0,-1,"","JW_LIN","PASSWD"}, \
				{0,-1,"","JW_STM","PASSWD"},  {0,-1,"","JW_SQL","PASSWD"}, \
				{0,-1,"","ATOM","PASSWD"},  {0,-1,"","POT","PASSWD"}, \
				{0,-1,"","PHONE","PASSWD"},  {0,-1,"","11","PASSWD"}, \
				...
				{0,-1,"","30","PASSWD"},  {0,-1,"","KSH_SQL","PASSWD"}, \
				{0,-1,"","KSH_UBT","PASSWD"}, {0,-1,"","KSH_ARD","PASSWD"}, \
				{0,-1,"","KSH_AND","PASSWD"}, {0,-1,"","KSH_LIN","PASSWD"}, \
				{0,-1,"","JW_BT","PASSWD"}, {0,-1,"","JW_TEST","PASSWD"}, \
				{0,-1,"","HM_CON","PASSWD"}};
